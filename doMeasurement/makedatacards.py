...
def makedir(dic, updatejson=True):
	...
	#os.system('cp Pieces/launchcombine-unblind.py datacardsOutputs_KD'+str(dic['interp'])+'_'+inputs+'_'+dic['suffix']+'/' + name2 + '/')
...
def makecards(dic, fs):
	...
	myReader = inputReader('/afs/cern.ch/work/c/chenguan/CMSRunII-HiggsMassMears/HZZMassMeasTemplatesMaker/doMeasurement/commoninputs/SM_inputs_13TeV/'+year+'/inputs_'+fs+'.txt')
	myReader.readInputs()
