...
#        if tin.mass4l > 105 and tin.mass4l < 140:
           ...
           if fs == "4mu" and tin.finalState == 1 and tin.mass4l > 105 and tin.mass4l < 140:#tin.mass4mu > 105 and tin.mass4mu < 140: 
              CMS_zz4l_mass[0] = tin.mass4lREFIT
#              melaLD[0] = tin.melaLD
              melaLD[0] = tin.D_bkg_kin
#              CMS_zz4l_massErr[0] = tin.CMS_zz4l_massErr/tin.mass4mu
              CMS_zz4l_massErr[0] = tin.mass4lErrREFIT/tin.mass4lREFIT
              tout.Fill()
           if fs == "4e" and tin.finalState == 2 and tin.mass4l > 105 and tin.mass4l < 140: #tin.mass4e < 140:           
              CMS_zz4l_mass[0] = tin.mass4lREFIT
#              melaLD[0] = tin.melaLD
              melaLD[0] = tin.D_bkg_kin
...
#              CMS_zz4l_massErr[0] = tin.CMS_zz4l_massErr/tin.mass2e2mu
              CMS_zz4l_massErr[0] = tin.mass4lErrREFIT/tin.mass4lREFIT
              print tin.mass4lREFIT, tin.mass4lErrREFIT/tin.mass4lREFIT
              tout.Fill()              
#           melaLD[0] = tin.D_bkg_kin
