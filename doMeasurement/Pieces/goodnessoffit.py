...
def runcombineforwidth(file_, computer, withsyst, toyn, poi, floatothers, ranges):
	...
	fixed_options2 = '-M GoodnessOfFit -d '+outputname+'.root -P '+poi+' --setParameters HiggsDecayWidth=0.004,MH=125.0 --floatOtherPOIs='+floatothers+' --robustFit=0 --algo=singles -D '+toyn
