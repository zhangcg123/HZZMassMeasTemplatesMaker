...
int main(int argc, char* argv[]){
	...
	if(isData == "data" && year == "2016post") f = new TFile("/eos/user/f/ferrico/www/FullRun2/20165/Data_SingleElectron_Run2016post.root","READ");
	if(isData == "data" && year == "2016pre") f = new TFile("/eos/user/f/ferrico/www/FullRun2/20165/Data_SingleElectron_Run2016pre.root","READ");
