...
def run(cut_,inputname,outpath,outname,var1name):
	vars = 'RelIso1/RelIso2/Sip1/Sip2/ele1_ptpostcorr/ele2_ptpostcorr/lep1_ecalDriven/lep2_ecalDriven/ele_et1/ele_et2/eta1/eta2/mass2e_corr/Zpt/Zy'
	cut_ = cut_
...
commoncut = '-3<Zy<3 && RelIso1<0.35 && RelIso2<0.35 && Sip1<4 && Sip2<4 && lep1_ecalDriven==1 && lep2_ecalDriven==1 && -2.5<eta1<2.5 && -2.5<eta2<2.5 && 60<mass2e_corr<120 && 0<Zpt<120'
...
'''
ys = [year+'_lomc',year+'_nlomc',year+'_data']
