...
void multirun(int top, int bottom,TH1F* h ){			//this function should be self-contained
	...
	for(int i=top; i<bottom; i++){
		...
		if(vars_i[0]==1 && vars_i[1]==1 && vars_f[0]<0.35 && vars_f[1]<0.35 && vars_f[2]<4 && vars_f[3]<4 && vars_f[4]<5000 && vars_f[5]<5000 && vars_f[6]>32 && vars_f[7]>20 && -2.5<vars_f[8] && vars_f[8]<2.5 && -2.5<vars_f[9] && vars_f[9]<2.5 && 80<vars_f[10] && vars_f[10]<100){
			h->Fill(vars_f[10]);
		}
	}
}
