...
void multirun(int top, int bottom,TH1F* h ){			//this function should be self-contained
	...
	for(int i=top; i<bottom; i++){
		...
		if(vars_i[0]==1 && vars_i[1]==1 && vars_f[0]<0.35 && vars_f[1]<0.35 && vars_f[2]<4 && vars_f[3]<4 && 80<vars_f[4] && vars_f[4]<100 && vars_f[5]<5000 && vars_f[6]<5000 && vars_f[7]>32 && vars_f[8]>20 && -2.5<vars_f[9] && vars_f[9]<2.5 && -2.5<vars_f[10] && vars_f[10]<2.5 && 0.5<vars_f[11] && vars_f[11]<1.1 && 0.5<vars_f[12] && vars_f[12]<1.1){
			h->Fill(vars_f[4]);
		}
	}
}
