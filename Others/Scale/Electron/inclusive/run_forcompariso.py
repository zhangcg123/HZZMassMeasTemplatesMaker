...
def run(cut_,massname_,inputname,outpath,outname):
	...
	vars = 'RelIso1/RelIso2/Sip1/Sip2/'+massname_+'/ele1_ptpostcorr/ele2_ptpostcorr/lep1_ecalDriven/lep2_ecalDriven/ele_et1/ele_et2/eta1/eta2'
	cut_ = cut_ + ' && ' + masscut
...
dict = {
	...
	'2016pre_data':'crab_DYJetsToLL_M50_2016APV_2e_slimmed.root',
...
dirclass = DirTree()
dirclass.mkrootdir(year+'_elescale_1bin_inclusiver9_lo_vs_nlo_withfsr_bwxdcb_rmbkg_'+masslow+'_'+masshigh)
...
for cut in cutsdict:
	...
	for massname in ['mass2e_corr_data','mass2e_corr_mc','mass2e_scaleup_mc','mass2e_smearup_mc']:
		...
		massname = massname.split('_')[0]+'_'+massname.split('_')[1] + '_fsr'
...
tmp = ScatterPlot1([obj1,obj2,obj3],['madgraph','amcatnlo'],['-'],baseoutdir+'peak',year)
...
obj3.GetXaxis().LabelsOption('h')
obj3.GetXaxis().SetLabelOffset(0.02)
tmp = ScatterPlot1([obj1,obj2,obj3],['madgraph','amcatnlo'],['-'],baseoutdir+'sigma',year)
