...
if False:
	dirclass = DirTree()
	dirclass.mkrootdir(year+'_'+fs+'_'+low+'_'+high+'_'+init_mean+'_'+buffer_+'_nlo_fixdoublecountissue_2kfft_doublecbwithbkg_iso3p5sip4dxy0p5_withtriggercut_withetcut_noweightedmc_ptcut5k_mc2p49_nofsr_mccorr_vs_dataewk2')
...
#				dirclass.mksubdir(name+'/'+i+'/'+j_+j)
	...
	descrip = fs + ' scale with 20summer ultra-legacy '+year+'DATA vs. DYJetsToLL_amcatnlo: first test, for pt eta phi, weighted, mass window '+low+'-'+high+', init_mean '+init_mean+', buffer '+buffer_+', cut on pt1<1000 && pt2<1000.\n with fsr.\n no 1.44-1.56, et cut 32 20, no low pt cut, double fft sampling'
...
plotpath = ''
if year == '2016pre':
	plotpath = '/eos/user/c/chenguan/www/TESTPLOTS/04_Apr_2022/timestamp_12_36_39_447711_2016pre_2mu_80_100_-0.5_0.2_nlo_fixdoublecountissue_2kfft_doublecbwithbkg_iso3p5sip4dxy0p5_withtriggercut_withetcut_noweightedmc_ptcut5k_mc2p49_nofsr_mccorr_vs_dataewk2/'
if year == '2016post':
	plotpath = '/eos/user/c/chenguan/www/TESTPLOTS/04_Apr_2022/timestamp_12_45_47_229022_2016post_2mu_80_100_-0.5_0.2_nlo_fixdoublecountissue_2kfft_doublecbwithbkg_iso3p5sip4dxy0p5_withtriggercut_withetcut_noweightedmc_ptcut5k_mc2p49_nofsr_mccorr_vs_dataewk2/'
if year == '2017':
	plotpath = '/eos/user/c/chenguan/www/TESTPLOTS/04_Apr_2022/timestamp_12_19_09_304604_2017_2mu_80_100_-0.5_0.2_nlo_fixdoublecountissue_2kfft_doublecbwithbkg_iso3p5sip4dxy0p5_withtriggercut_withetcut_noweightedmc_ptcut5k_mc2p49_nofsr_mccorr_vs_dataewk2/'
if year == '2018':
	plotpath = '/eos/user/c/chenguan/www/TESTPLOTS/04_Apr_2022/timestamp_11_08_30_961837_2018_2mu_80_100_-0.5_0.2_nlo_fixdoublecountissue_2kfft_doublecbwithbkg_iso3p5sip4dxy0p5_withtriggercut_withetcut_noweightedmc_ptcut5k_mc2p49_nofsr_mccorr_vs_dataewk2/'
...
for d_ in ['mc']:
	...
	for ud in ['up']:
		...
		sd_err[d_][ud] = {}
		for k in kandc:
				peak_err[d_][ud][k] = ListQrtSum([peak_var[d_]['mass2mu_ewk_dt'][k],peak_var[d_]['mass2mu_zpt_dt'][k],peak_var[d_]['mass2mu_dm_dt'][k],datamc[d_]['mass2mu_ewk2']['peakerr'][k],datamc['mc']['mass2mu_ewk2']['peakerr'][k]]).result
...
for kkk in ['phi','eta','pt']:
	...
	if fs == '2mu':
		mcconfig['ytitle'] = 'Z_{#mu#mu}^{mass}'
		dtconfig['ytitle'] = 'Z_{#mu#mu}^{mass}'
