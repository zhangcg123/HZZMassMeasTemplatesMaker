...
int main(int argc, char* argv[]){
	...
	if(fs == "2mu"){
		if(isdata=="mc" && year == "2016pre" ) subname = "crab_DYJetsToLL_M50_2016APV_2mu_slimmed.root";
		if(isdata=="data" && year == "2016pre" ) subname = "crab_SingleMuon2016HIPM_2mu_slimmed.root";
		if(isdata=="mc" && year == "2016post" ) subname = "crab_DYJetsToLL_M50_2016_2mu_slimmed.root";
		if(isdata=="data" && year == "2016post" ) subname = "crab_SingleMuonRun2016_2mu_slimmed.root";
		if(isdata=="mc" && year == "2018" )subname=/*"crab_DYJetsToLL_Madgraph_20UL18_2mu_slimmed.root";*/"crab_DYJetsToLL_M50_2018_2mu_slimmed.root";
		if(isdata=="data" && year == "2018")subname="crab_SingleMuon_Run18_2mu_slimmed.root";
		if(isdata=="mc" && year == "2017")subname="crab_DYJetsToLL_M50_2017_new_2mu_slimmed.root";
