...
void SignalShape_(TString plotpath, TString plotpath2, TString plotpath3, int fs, TString type, TString tag, TString year, int cates, TString steponedir){
	...
	if(BASE=="20UL")f_120 = new TFile("/afs/cern.ch/work/c/chenguan/CMSRunII-HiggsMassMears/HZZMassMeasTemplatesMaker/Others/Slimmer/OutPutTrees/"+year+"/GluGluHToZZTo4L_M120_"+year+"_skimmed.root");
	...
	if(BASE=="20UL")f_124 = new TFile("/afs/cern.ch/work/c/chenguan/CMSRunII-HiggsMassMears/HZZMassMeasTemplatesMaker/Others/Slimmer/OutPutTrees/"+year+"/GluGluHToZZTo4L_M124_"+year+"_skimmed.root");
	...
	if(BASE=="20UL")f_125 = new TFile("/afs/cern.ch/work/c/chenguan/CMSRunII-HiggsMassMears/HZZMassMeasTemplatesMaker/Others/Slimmer/OutPutTrees/"+year+"/GluGluHToZZTo4L_M125_"+year+"_skimmed.root");
	...
	if(BASE=="20UL")f_126 = new TFile("/afs/cern.ch/work/c/chenguan/CMSRunII-HiggsMassMears/HZZMassMeasTemplatesMaker/Others/Slimmer/OutPutTrees/"+year+"/GluGluHToZZTo4L_M126_"+year+"_skimmed.root");
	...
	if(BASE=="20UL")f_130 = new TFile("/afs/cern.ch/work/c/chenguan/CMSRunII-HiggsMassMears/HZZMassMeasTemplatesMaker/Others/Slimmer/OutPutTrees/"+year+"/GluGluHToZZTo4L_M130_"+year+"_skimmed.root");
